...
class TestMoonPhase(unittest.TestCase):
    ...
    def test_get_compatability_new_moon(self):
        ...
        self.assertEqual(PyMoon.get_compatability(phase), expected_output)
    ...
    def test_get_personality_waxing_crescent(self):
        ...
        self.assertEqual(PyMoon.get_personality(phase), expected_output)
    ...
    def test_get_life_suggestion_waxing_crescent(self):
        ...
        self.assertEqual(PyMoon.get_life_suggestion(phase), expected_output)
    ...
    def test_get_compatibility_invalid_phase(self):
        ...
        result = PyMoon.get_compatability(invalid_phase)
